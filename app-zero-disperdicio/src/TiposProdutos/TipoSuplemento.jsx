...
function Tabela(props) {
    return (
        <table>
            ...
            <tbody>
                {props.projeto.filter((projeto) => projeto.categoria === 'suplementos').map((projeto) => <LinhaTabela key={projeto.id} projeto={projeto} onClickExcluirProjeto={props.onClickExcluirProjeto} />)}
            </tbody>
        </table>
    );
}